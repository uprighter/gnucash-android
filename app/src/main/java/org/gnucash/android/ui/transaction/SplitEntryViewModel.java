...
//        Log.d(LOG_TAG, "getInputAccountPos, old value " + this.inputAccountPos);
    ...
    // This function is supposed to fix the 'Unknown attribute android:selectedItemPosition' error
    // in item_split_entry.xml, but it doesn't seem helpful.
    @BindingAdapter("android:selectedItemPosition")
    public static void setSelectedItemPosition(Spinner spinner, int position) {
